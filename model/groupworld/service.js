  ...
  async init() {
    ...
    this._initPromise = (async () => {
      try {
        ...
        this.segmenter = new ConversationSegmenter({ dao, trace: this.trace })
        ...
        this.analyzer = new WorldAnalyzer({ provider: this.provider, dao, segmenter: this.segmenter, resolver: this.resolver, cfg: cFn, trace: this.trace })
