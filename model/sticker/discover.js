...
{"isSticker": true或false, "name": "4字以内的中文名称", "desc": "一句话说明这个表情的意思或用法（必填，10~30字，写清什么场景下用）", "tags": ["开心","无奈","赞同","摸鱼","666"]}
...
要求：
- desc 必须填写，描述这个表情的含义和使用场景（例如"对方说了离谱的话时用来表达无奈"），不能为空、不能只重复 name。
- name 是 2~4 个字的简洁中文名，看到名就能想到画面。
