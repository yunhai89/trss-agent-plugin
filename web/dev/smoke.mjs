...
for (const f of ['dashboard', 'config', 'memory', 'recall', 'profile', 'personas', 'skills', 'sessions', 'logs', 'schedule', 'confirm', 'suggestions', 'evolution', 'kb', 'humanize', 'groupworld', 'selfstate', 'sticker']) {
