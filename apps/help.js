...
const SECTIONS = [
  ...
  },
  {
    title: '示意图',
    commands: [
      { cmd: '画一张/画一下 +内容', desc: '对话中直接说"画一下XX的流程图/架构图/时序图/状态图"，Agent 生成精确示意图并发图（非文生图模型，文字/连线准确）' },
    ],
  },
  {
    title: '记忆 / 提醒',
  ...
  },
  {
    ...
    commands: [
      ...
      { cmd: '#伪人状态', desc: '主人：查看伪人模式运行状态（白名单群/活跃运行时）' },
      { cmd: '#伪人决策 +n', desc: '主人：查看最近 n 条伪人门控/规划 trace' },
      { cmd: '#伪人记忆 +群号', desc: '主人：查看伪人独立记忆库（印象/事件/群梗，每日自动整合）' },
