...
(function () {
  ...
  const config = {
    ...
    jev: {
      enable: false, providerId: '', modelId: '', model: '',
      timeoutMs: 4000, maxRetries: 1, maxStateChars: 32000, toolSelectionMaxTools: 80,
      decisions: { llmTool: false, terminalRisk: false },
      allowDestructive: false,
      thresholds: { lowConfidence: 0.5, highConfidence: 0.9, thinkingMinConfidence: 0.5, toolNoulFloor: 0.6, terminalRiskFloor: 0.75, reflectFloor: 0.5 },
    },
    shell: { intercept: [] },
    maxTokens: null,
    contextWindow: 32000,
  ...
  const logFiles = [
    { file: '960179589-2854196310-c_1001-20260728_221030.log', label: '群 960179589 · 云汐 · 07-28 22:10', events: [
      ...
      { level: 'info', time: '2026-07-28T22:10:30.640Z', event: 'jev', traceId: t1, kind: 'thinking', depth: 'medium', confidence: 0.88, model: 'jev-1.13.0', usage: { input_tokens: 142, output_tokens: 0 }, ms: 186 },
      { level: 'info', time: '2026-07-28T22:10:30.880Z', event: 'jev', traceId: t1, kind: 'tool_select', selected: ['terminal'], candidateCount: 32, threshold: 0.6, availableCount: 32, available: [{ name: 'terminal', score: 0.92 }, { name: 'calc', score: 0.21 }], rejected: [{ name: 'calc', score: 0.21, reason: 'below_threshold' }], model: 'jev-1.13.0', usage: { input_tokens: 311 }, ms: 214 },
      ...
      { level: 'info', time: '2026-07-28T22:10:34.120Z', event: 'sandbox', traceId: t1, command: 'ss -tlnp | grep 2536', exitCode: 0, ok: true, timedOut: false, aborted: false, sandboxError: null, duration: 258 },
      { level: 'info', time: '2026-07-28T22:10:34.130Z', event: 'jev', traceId: t1, kind: 'shell_risk', command: 'rm -rf /tmp/build', risk: 'destructive', confidence: 0.42, blocked: true, fallback: false, model: 'jev-1.13.0', usage: { input_tokens: 88 }, ms: 173 },
